<footer>
    <div class="footer-grid">
        <div class="footer-section contact-info">
            ...
            <p>Email: rogit31@gmail.com</p>
            <p>Discord: naturaldisc</p>
        </div>
        ...
        <div class="footer-section site-info">
            ...
            <p>Last updated on September 8<sup>th</sup></p>
            <p>Disclaimer: this website includes artwork and content sourced from various artists and creators. Their
                content is the intellectual property of their respective owners, including but not limited to Wizards of
                the Coast and individual artists.</p>
        </div>

        <div class="footer-section copyright-info">
            <h3>Copyright Information</h3>
            <p>The content on this website is intended for personal and academic use, and falls under fair dealing. If
                you would like any of your content removed from this website, please contact me at
                rogit31@gmail.com. </p>
        </div>
    </div>
</footer>